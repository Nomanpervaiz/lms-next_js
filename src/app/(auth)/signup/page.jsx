            ...
            <div className="p-10 bg-gray-200 shadow-md w-full max-w-md rounded-xl flex flex-col justify-center items-center">
                ...
                <form
                    ...
                    <label className="font-semibold">
                        Name
                        <input name="name" required className="block w-80 bg-gray-50 rounded-xl p-2" type="text" />
                    </label>
                    <label className="font-semibold">
                        Email
                    ...
                    <button type="submit" className="border py-2 px-4 mt-6 bg-blue-500 text-white w-40 mx-auto rounded-xl">Signup</button>
                </form>
                <form
                    action={async () => {
                        "use server"
